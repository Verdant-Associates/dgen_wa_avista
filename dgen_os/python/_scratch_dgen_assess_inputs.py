...
# with pd.ExcelWriter(output_root / 'dgen_inputs_for_review.xlsx', engine='xlsxwriter') as writer:
#     for ifile in input_files:
#         df = pd.read_csv(ifile)
#         df.to_excel(writer, sheet_name=ifile.split('\\')[-1].split('.')[0], index=False)
